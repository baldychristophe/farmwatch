...
const getActivePools = async (userAddress: string): Promise<Array<{ poolUserInfo: { amount: BigNumber, rewardDebt: BigNumber }, index: number }>> => {
  ...
  poolInfos[6] = { amount: BigNumber.from("925698000000000000"), rewardDebt: BigNumber.from("214568000000000000") }
  poolInfos[7] = { amount: BigNumber.from("925698000000000000"), rewardDebt: BigNumber.from("214568000000000000") }
  // poolInfos[8] = { amount: BigNumber.from("925698000000000000"), rewardDebt: BigNumber.from("214568000000000000") }
  // poolInfos[9] = { amount: BigNumber.from("925698000000000000"), rewardDebt: BigNumber.from("214568000000000000") }
  return poolInfos
